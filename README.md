...
| 📖 **Env reference docs** | [`docs/ENV_DEEP.md`](docs/ENV_DEEP.md) (11 hand‑curated tasks · Rounds 1 + 2) · [`docs/ENV_SHALLOW.md`](docs/ENV_SHALLOW.md) (381 procedural scenarios · Round 3) — full per‑task / per‑action / per‑reward spec |
